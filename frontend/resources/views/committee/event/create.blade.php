            ...
            <div class="card-body">
                ...
                <form id="createEventForm" action="{{ route('committee.event.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="speaker" name="speaker" value="{{ old('speaker') }}"
                            required placeholder="Enter speaker name">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-text">Optional: Upload event poster (JPG, PNG, GIF)</div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "You are about to create a new event!",
                    icon: 'question',
