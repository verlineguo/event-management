    ...
    public function index()
    {
        try {
            ...
            if ($response->successful()) {
                ...
                return view('guest.home', compact('transformedEvents'));
            }
    ...
    public function events()
    {
        try {
            ...
            if ($response->successful()) {
                ...
                return view('guest.events', compact('transformedEvents', 'categories'));
            }
    ...
    public function showEvent($id)
    {
        try {
            ...
            if ($response->successful()) {
                ...
                return view('guest.event-detail', compact('event', 'userRegistration'));
            }
